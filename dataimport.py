...
def RunScoutnetImport(groupid: str, api_key: str, user: ScoutnetUser, semester: Semester, result: TaskProgress) -> bool:

    if not user.canImport(groupid):
        result.error(f'Får inte importera för kår med id: {groupid}. Se dina roller i scoutnet.')
        return False
